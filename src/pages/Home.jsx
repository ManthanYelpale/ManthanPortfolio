        ...
        <div className="relative w-full text-white selection:bg-cyan-500/30">
            ...
            <section id="home" className="min-h-screen flex flex-col items-center justify-center p-6 bg-transparent text-center">
                <motion.div
                    className="space-y-4"
                >
                    <h1 className="text-7xl md:text-9xl font-black tracking-tight uppercase text-white font-inter">
                        Manthan Yelpale
                    </h1>
                    <p className="text-2xl md:text-4xl font-semibold tracking-wide uppercase font-inter text-white/90 mt-4">
                        AI Intern
                    </p>
                </motion.div>
            </section>
            ...
            <section className="min-h-[70vh] py-40 px-6 flex items-center justify-center bg-transparent">
                <div className="max-w-4xl space-y-24">
                    ...
                    >
                        Exploring the frontiers of <DynamicText variant="primary" className="font-bold">Generative AI</DynamicText> and <DynamicText variant="secondary" className="font-bold">Computer Vision</DynamicText>.
